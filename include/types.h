...
// fixed point
using i32x8 = oter::FixedPoint<i32, u8>;
...
// Angle
using Angle = oter::Angle;

inline oter::Angle operator""_d(long double value)
{
	return Angle(value);
}

// Matrix
using m3f = oter::Matrix<f32, 3, 3>;

// Vector2
template <typename T>
using v2 = oter::Vector2<T>;
using v2u = v2<u32>;
using v2i = v2<i32>;
using v2x = v2<i32x8>;
using v2f = v2<f32>;
...
// Transform
using Transform = oter::Transform;
